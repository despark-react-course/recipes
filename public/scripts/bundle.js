...
var User = function () {
    function User() {
        ...
        this.generateActions('loginSuccess', 'loginFail', 'logoutSuccess');
    }
    ...
    _createClass(User, [{
        ...
        value: function login() {
            ...
            $.ajax({
                ...
                return _this.loginSuccess(data);
            }).fail(function (error) {
...
exports.default = _alt2.default.createActions(User);

},{"../alt":35}],34:[function(require,module,exports){
'use strict';
...
},{"./User":33}],35:[function(require,module,exports){
'use strict';
...
},{"alt":3}],36:[function(require,module,exports){
'use strict';
...
var App = function (_Component) {
    ...
    function App(props) {
        ...
        _this.state = _stores.UserStore.getState();
...
},{"../actions":34,"../stores":41,"react":"react"}],37:[function(require,module,exports){
'use strict';
...
},{"./routes":39,"history/lib/createBrowserHistory":20,"react":"react","react-dom":"react-dom","react-router":"react-router"}],39:[function(require,module,exports){
'use strict';
...
},{"./components/App":36,"./components/Home":37,"react":"react","react-router":"react-router"}],40:[function(require,module,exports){
'use strict';
...
var User = function () {
    ...
    _createClass(User, [{
        ...
        key: 'onLoginFail',
        value: function onLoginFail(error) {
...
exports.default = _alt2.default.createStore(User);

},{"../actions":34,"../alt":35}],41:[function(require,module,exports){
'use strict';
